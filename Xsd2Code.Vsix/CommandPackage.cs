...
namespace Xsd2Code.Vsix
{
    ...
    [ProvideAutoLoad(Microsoft.VisualStudio.Shell.Interop.UIContextGuids.SolutionExists, PackageAutoLoadFlags.BackgroundLoad)] // auto load
    public sealed class CommandPackage : AsyncPackage
    {
        /// <summary>
        /// CommandPackage GUID string.
        /// </summary>
        public const string PackageGuidString = "47ba29aa-55ec-4c4e-8822-b1dbab3e5d62";
